#ifndef RADIO_MANAGER_TDA7703_H
#define RADIO_MANAGER_TDA7703_H
...
class RadioManager_TDA7703:public AbstractRadio
{
	Q_OBJECT
public:
    RadioManager_TDA7703();
    ~RadioManager_TDA7703();
...
public:
    ...
    int beginSearch(int channel,bool isListenTest);
...
private:
	...
	void readParameterConfig( int frequencySection, int *smeter, int *detun, int *multi, int *adj );
