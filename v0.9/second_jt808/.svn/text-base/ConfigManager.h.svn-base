...
#define DEFAULT_MAIN_SERVER_APN					"CMNEET"
typedef struct
{
    string name;
    int col;
...
private:
    ...
    const static StruStringConfigItem m_stringItems_base[];
    const static StruIntConfigItem m_intItems[];
    const static StruIntConfigItem m_intItems_base[];
