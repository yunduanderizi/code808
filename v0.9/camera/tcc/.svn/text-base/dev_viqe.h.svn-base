...
typedef	volatile struct {
	...
	/*
	HI_SEG0_U				uHI_SEG0;				// 0x620
	HI_SEG1_U				uHI_SEG1;				// 0x624
	HI_SEG2_U				uHI_SEG2;				// 0x628
	HI_SEG3_U				uHI_SEG3;				// 0x62c
	*/
	HI_SEGS					bHI_SEGS;				// 0x620 ~ 0x62c
	/*
	HI_CDF0_U				uHI_CDF0;				// 0x630
	HI_CDF1_U				uHI_CDF1;				// 0x634
	HI_CDF2_U				uHI_CDF2;				// 0x638
	HI_CDF3_U				uHI_CDF3;				// 0x63c
	*/
	HI_CDFS					bHI_CDFS;				// 0x630 ~ 0x63c

	/*
	HI_PDF0_U				uHI_PDF0;				// 0x640
	HI_PDF1_U				uHI_PDF1;				// 0x644
	HI_PDF2_U				uHI_PDF2;				// 0x648
	HI_PDF3_U				uHI_PDF3;				// 0x64c
	HI_PDF4_U				uHI_PDF4;				// 0x650
	HI_PDF5_U				uHI_PDF5;				// 0x654
	HI_PDF6_U				uHI_PDF6;				// 0x658
	HI_PDF7_U				uHI_PDF7;				// 0x65c
	*/
	HI_PDFS					bHI_PDFS;				// 0x640 ~ 0x65c

	/*
	HI_SCALE0_U				uHI_SCALE0;				// 0x660
	HI_SCALE1_U				uHI_SCALE1;				// 0x664
	HI_SCALE2_U				uHI_SCALE2;				// 0x668
	HI_SCALE3_U				uHI_SCALE3;				// 0x66c
	*/
