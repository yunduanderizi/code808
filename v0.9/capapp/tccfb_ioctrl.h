...
#if defined(CONFIG_TCC_NOT_ANDROID) && (defined(CONFIG_TCC_FSMA) || defined(CONFIG_TCC_miniSTB)) && (defined(CONFIG_TCC_FSMA_DUPLICATE) || defined(CONFIG_TCC_MINISTB_DUPLICATE))
#define TCC_LCDC_COMPOSITE_GET_DUPLICATE_BASEADDRESS	0x0022
#define TCC_LCDC_COMPOSITE_GET_DUPLICATE_TVMODE			0x0023
#define TCC_LCDC_COMPOSITE_SET_DUPLICATE_TVMODE			0x0024
#define TCC_LCDC_COMPOSITE_SET_DUPLICATE_SCALEPARAM		0x0025
#define TCC_LCDC_COMPOSITE_GET_DUPLICATE_SCALEPARAM		0x0026
#endif
...
#if defined(CONFIG_TCC_NOT_ANDROID) && defined(CONFIG_TCC_FSMA)
#define TCC_LCDC_SET_OUTPUT_POSITION_PARAM		0x0044
#define TCC_LCDC_GET_OUTPUT_POSITION_PARAM		0x0045
#endif
...
struct display_platform_data 
{
	...
	unsigned int output;
	unsigned int hdmi_resolution;
	unsigned int composite_resolution;
	unsigned int component_resolution;
}; 
...
typedef struct 
{
	unsigned int uiOutMode;
	unsigned int uiOutputPositionX;
	unsigned int uiOutputPositionY;
	unsigned int uiOutputTrimWidth;
	unsigned int uiOutputTrimHeight;
}STDISPLAY_OUTPUT_POSITION_PARAM;
#endif
