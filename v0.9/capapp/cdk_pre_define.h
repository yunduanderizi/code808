...
*************************************************************************/
	...
	// Supported Demuxer
	//------------------------------------------------------
#ifdef TCC_VIDEO_DEMUX_INCLUDE
	#define INCLUDE_VIDEO_DMX

#ifdef TCC_MP4_INCLUDE
	#define INCLUDE_MP4_DMX
#endif

#ifdef TCC_MPG_INCLUDE
	#define INCLUDE_MPG_DMX
	#define INCLUDE_VOB_DMX
#endif

#ifdef TCC_MKV_INCLUDE
	#define INCLUDE_MKV_DMX
#endif

#ifdef TCC_AVI_INCLUDE
	#define INCLUDE_AVI_DMX
#endif

#ifdef TCC_TS_INCLUDE
	#define INCLUDE_TS_DMX
#endif

#ifdef TCC_ASF_INCLUDE
	#define INCLUDE_ASF_DMX
#endif

#ifdef TCC_RMFF_INCLUDE
	#define INCLUDE_RMFF_DMX
#endif

#ifdef TCC_OGG_INCLUDE
	#define INCLUDE_OGG_DMX
#endif

#ifdef TCC_FLV_INCLUDE
	#define INCLUDE_FLV_DMX
	#ifdef INCLUDE_FLV_DMX
	#	define FLV_DMX_AVC_TS_OPTION	1  //(0:DTS, 1:PTS)
	#endif
#endif
#endif //TCC_VIDEO_DEMUX_INCLUDE

#ifdef TCC_AUDIO_DEMUX_INCLUDE
...
//	#define INCLUDE_MP4_MUX
	#define INCLUDE_WMA_MUX
	#ifdef INCLUDE_WMA_MUX
	#	undef SAVE_EACH_PACKETDATA_MODE
	#endif
...
//	#define VPU_CLK_CONTROL
	...
	//------------------------------------------------------
	#define VPU_REG_BASE_ADDR			0xF0700000	//Video CODEC
	...
	#define VIDEOCODECBUS_CLK_BASE_ADDR	0xF0400000	//CLKCTRL5: 0xF0400014 Core clock control register for video codec
													//CLKCTRL6: 0xF0400018 Bus clock control register for video codec

	//------------------------------------------------------
	// Supported Video Decoder
	//------------------------------------------------------
#ifdef TCC_VPU_DEC_INCLUDE
	#define INCLUDE_VPU_DEC
	#ifdef INCLUDE_VPU_DEC

	#ifdef TCC_H264_DEC_INCLUDE
		#define INCLUDE_H264_DEC
	#endif

	#ifdef TCC_H263_DEC_INCLUDE
		#define INCLUDE_H263_DEC
	#endif

	#ifdef TCC_MPEG4_DEC_INCLUDE
		#define INCLUDE_MPEG4_DEC
	#endif

	#ifdef TCC_MPEG2_DEC_INCLUDE
		#define INCLUDE_MPEG2_DEC
	#endif

	#ifdef TCC_RV9_DEC_INCLUDE
		#define INCLUDE_RV9_DEC
	#endif

	#ifdef TCC_VC1_DEC_INCLUDE
		#define INCLUDE_VC1_DEC
	#endif

	#ifdef TCC_DIV3_DEC_INCLUDE
		#define INCLUDE_DIV3_DEC
	#endif

	#ifdef TCC_AVS_DEC_INCLUDE
		#define INCLUDE_AVS_DEC
	#endif

	#ifdef TCC_MJPEG_DEC_INCLUDE
		#define INCLUDE_MJPEG_DEC
	#endif

	#endif
#endif

#ifdef TCC_WMV78_SW_INCLUDE
	#define INCLUDE_WMV78_DEC
#endif

#ifdef TCC_H263_SW_INCLUDE
...
*************************************************************************/
#ifdef TCC_AUDIO_ENC_INCLUDE
	#define INCLUDE_AUDIO_ENC

#ifdef TCC_AAC_ENC_INCLUDE
	#define INCLUDE_AAC_ENC
#endif

#ifdef TCC_EVRC_ENC_INCLUDE
	#define INCLUDE_EVRC_ENC
#endif

#ifdef TCC_MP3_ENC_INCLUDE
	#define INCLUDE_MP3_ENC
#endif

#ifdef TCC_WAV_ENC_INCLUDE
	#define INCLUDE_WAV_ENC
#endif

#ifdef TCC_WMA_ENC_INCLUDE
	#define INCLUDE_WMA_ENC
#endif
#endif //TCC_AUDIO_ENC_INCLUDE


#ifdef TCC_AUDIO_DEC_INCLUDE
	#define INCLUDE_AUDIO_DEC

#ifdef TCC_AAC_DEC_INCLUDE
	#define INCLUDE_AAC_DEC
#endif

#ifdef TCC_MP3_DEC_INCLUDE
	#define INCLUDE_MP3_DEC
#endif

#ifdef TCC_MP3HD_DEC_INCLUDE
	#define INCLUDE_MP3HD_DEC
#endif

#ifdef TCC_MP2_DEC_INCLUDE
	#define INCLUDE_MP2_DEC
#endif

#ifdef TCC_TEST_DTS_INCLUDE
	#define INCLUDE_DTS_DEC
#endif
	//------------------------------------------------------
	// Supported DTS Decoder Ver 2
	//------------------------------------------------------
	//#define INCLUDE_DTS_Ver2

#ifdef TCC_AC3_INCLUDE
	#define INCLUDE_AC3_DEC
#endif

	#ifdef ARM_LINUX
//	#define INCLUDE_DDP_DEC
	#endif

	//#ifndef INCLUDE_AC3_DEC
	//#define INCLUDE_A52_DEC
	//#endif

//	#ifdef INCLUDE_DDP_DEC
//	#undef  INCLUDE_AC3_DEC
//	#undef  INCLUDE_A52_DEC
//	#endif

#ifdef TCC_WMA_DEC_INCLUDE
	#define INCLUDE_WMA_DEC
#endif

	//#define INCLUDE_RAG2_DEC
#ifdef TCC_FLAC_DEC_INCLUDE
	#define INCLUDE_FLAC_DEC
#endif

#ifdef TCC_APE_DEC_INCLUDE
	#define INCLUDE_APE_DEC
#endif

#ifdef TCC_WAV_DEC_INCLUDE
	#define INCLUDE_WAV_DEC
#endif

#ifdef TCC_VORBIS_DEC_INCLUDE
	#define INCLUDE_VORBIS_DEC
#endif

#ifdef TCC_BSAC_DEC_INCLUDE
	#define INCLUDE_BSAC_DEC
#endif

#ifdef TCC_COOK_DEC_INCLUDE
	#define INCLUDE_COOK_DEC
#endif
	//#define INCLUDE_DRA_DEC
	//#define INCLUDE_MP3HD_DEC

#ifdef TCC_QCELP_DEC_INCLUDE
	#define INCLUDE_QCELP_DEC
#endif

#ifdef TCC_AMRNB_DEC_INCLUDE
	#define INCLUDE_AMRNB_DEC
#endif

#ifdef TCC_AMRWBPLUS_DEC_INCLUDE
	#define INCLUDE_ARMWBPLUS_DEC
#endif

#ifdef TCC_EVRC_DEC_INCLUDE
	#define INCLUDE_EVRC_DEC
#endif
	//#define INCLUDE_G722_DEC
	//#define INCLUDE_G729AB_DEC
#endif //TCC_AUDIO_DEC_INCLUDE
...
#define STYLE_RESET		T_DEFAULT
	...
	#		if defined(_WIN32_WCE)
				static inline void dprintf(char *fmt, ...)
				{
					...
					//printf(TC_RED);
					CDK_DEBUG(CDK_DEB_LEV_ERR,"%s", buf);
					//printf(T_DEFAULT);
				}
