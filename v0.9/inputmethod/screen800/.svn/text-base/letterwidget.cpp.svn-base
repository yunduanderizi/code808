...
const EnglishButMember EnglishParameter[keyEngNumber]=
{
	...
	{9,		148,	90,62,QString("change")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{694,	148,	97,62,QString("del")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{107,	148,	89,62,QString("space")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{9,		8,		82,62,QString("hide")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{44,	78,		82,62,QString("abc")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
};
...
LetterWidget::LetterWidget():m_bCapital(false),lastKeyId(65535)
{
	...
	//PressLargeLabelText->setWindowFlags(Qt::WindowStaysOnTopHint|Qt::FramelessWindowHint|Qt::Tool);
	...
	for(i=0;i<keyEngNumber;i++)
	{
			...
			&& (event->y() > EnglishParameter[i].y) && (event->y() < EnglishParameter[i].y + EnglishParameter[i].Vheigth))
		{
			if(lastKeyId != i)
			{
				...
				if(i<26)
				{
					showPressLarge(EnglishParameter[i].text,this->geometry().x()+EnglishParameter[i].x,this->geometry().y()+EnglishParameter[i].y - 100,94,109);
				}
