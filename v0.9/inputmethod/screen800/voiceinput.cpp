...
{
	{224,	55,	173,27,QString("start")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{484,	55,	173,27,QString("stop")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{224,	122, 173,27,QString("del")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{484,	122, 173,27,QString("close")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{32,		175, 173,27,QString("change") /*,QPixmap(""),QPixmap(""),QPixmap("")*/}
};
