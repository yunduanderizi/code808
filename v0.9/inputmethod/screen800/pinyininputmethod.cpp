...
const LetterButMember letterParameter[keyNumber]=
{
	...
	{FX+35,						FY+keyheight+Vinterval,	Width,keyheight,QString("a")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+35+Width+Hsbacing,		FY+keyheight+Vinterval,	Width,keyheight,QString("s")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+35+(Width+Hsbacing)*2,	FY+keyheight+Vinterval,	Width,keyheight,QString("d")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+35+(Width+Hsbacing)*3,	FY+keyheight+Vinterval,	Width,keyheight,QString("f")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+35+(Width+Hsbacing)*4,	FY+keyheight+Vinterval,	Width,keyheight,QString("g")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+35+(Width+Hsbacing)*5,	FY+keyheight+Vinterval,	Width,keyheight,QString("h")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+35+(Width+Hsbacing)*6,	FY+keyheight+Vinterval,	Width,keyheight,QString("j")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+35+(Width+Hsbacing)*7,	FY+keyheight+Vinterval,	Width,keyheight,QString("k")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+35+(Width+Hsbacing)*8,	FY+keyheight+Vinterval,	Width,keyheight,QString("l")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},

	{FX+35+Width+Hsbacing,		FY+(keyheight+Vinterval)*2,Width,keyheight,QString("z")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+35+(Width+Hsbacing)*2,	FY+(keyheight+Vinterval)*2,Width,keyheight,QString("x")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+35+(Width+Hsbacing)*3,	FY+(keyheight+Vinterval)*2,Width,keyheight,QString("c")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+35+(Width+Hsbacing)*4,	FY+(keyheight+Vinterval)*2,Width,keyheight,QString("v")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+35+(Width+Hsbacing)*5,	FY+(keyheight+Vinterval)*2,Width,keyheight,QString("b")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+35+(Width+Hsbacing)*6,	FY+(keyheight+Vinterval)*2,Width,keyheight,QString("n")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+35+(Width+Hsbacing)*7,	FY+(keyheight+Vinterval)*2,Width,keyheight,QString("m")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	
	{80,	8,		63,	57,QString("right")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{9,		8,		63,	57,QString("left")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},

	{9,		213,	90,62,QString("change")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{694,	213,	97,62,QString("del")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{107,	213,	89,62,QString("space")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{9,		73,		82,62,QString("hide")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
};
...
void PinyinInput::SetAssociationBottonText(QStringList showlist)
{
	...
	if(nCount>0)
	{
		...
		else if(X == AssociationBottonX)
		{
			...
			IsPage = true;
    		AssociationBotton1->setGeometry(QRect(X, AssociationBottonY, 790, 50));
		...
		else if(X == AssociationBottonX)
		{
			...
			IsPage = true;
    		AssociationBotton2->setGeometry(QRect(X, AssociationBottonY, 790, 50));
		...
		else if(X == AssociationBottonX)
		{
        	...
        	pageButtonlist.append(tmpPage);
			IsPage = true;
    		AssociationBotton3->setGeometry(QRect(X, AssociationBottonY, 790, 50));
		...
		else if(X == AssociationBottonX)
		{
        	...
        	pageButtonlist.append(tmpPage);
			IsPage = true;
    		AssociationBotton4->setGeometry(QRect(X, AssociationBottonY, 790, 50));
		...
		else if(X == AssociationBottonX)
		{
        	...
        	pageButtonlist.append(tmpPage);
			IsPage = true;
    		AssociationBotton5->setGeometry(QRect(X, AssociationBottonY, 790, 50));
		...
		else if(X == AssociationBottonX)
		{
        	...
        	pageButtonlist.append(tmpPage);
			IsPage = true;
    		AssociationBotton6->setGeometry(QRect(X, AssociationBottonY, 790, 50));
		...
		else if(X == AssociationBottonX)
		{
        	...
        	pageButtonlist.append(tmpPage);
			IsPage = true;
    		AssociationBotton7->setGeometry(QRect(X, AssociationBottonY, 790, 50));
		...
		else if(X == AssociationBottonX)
		{
        	...
        	pageButtonlist.append(tmpPage);
			IsPage = true;
    		AssociationBotton8->setGeometry(QRect(X, AssociationBottonY, 790, 50));
	...
	for(i=0;i<keyNumber;i++)
	{
			...
			&& (event->y() > letterParameter[i].y) && (event->y() < letterParameter[i].y + letterParameter[i].Vheigth))
		{
			if(lastKeyId != i)
			{
				...
				if(i<26)
				{
					showPressLarge(letterParameter[i].text,this->geometry().x()+letterParameter[i].x,this->geometry().y()+letterParameter[i].y- 100,94,109);
				}
...
void PinyinInput::showpinyinlabel()
{
	...
	printf("-----------+++++++++++++++++++++++++++++++++-----tmp_scaled_height------%d--tmp_scaled_width %d---",tmp_scaled_height,tmp_scaled_width);
	tmp_PinyinBackground_Scaled = tmp_PinyinBackground_Pix.scaled(tmp_scaled_width + 50 ,tmp_scaled_height);
	ShowPinyinLabel->setGeometry(this->geometry().x()+160,this->geometry().y()-17,tmp_scaled_width,23);
