...
const DigitalButMember DigitalParameter[keyNumber]=
{
	...
	{FX,					FY+(keyheight+Vinterval)*2,	Width,keyheight,QString(",")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	...
	{415,	50,		60,42,QString("del")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{333,	95,		81,42,QString("space")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{415,	5,		60,42,QString("hide")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
};
