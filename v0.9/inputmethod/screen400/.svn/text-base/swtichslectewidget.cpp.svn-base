...
void SwitchWidget::init()
{
	...
	this->setGeometry(212,106,tmp_pixmap.width(),tmp_pixmap.height());
	...
	PB_Hand->setGeometry(16,16,bk_pixmap_press.width(),bk_pixmap_press.height());
	...
	PB_English->setGeometry(85,16,bk_pixmap_press.width(),bk_pixmap_press.height());
	...
	PB_Pinyin->setGeometry(16,63,bk_pixmap_press.width(),bk_pixmap_press.height());
	...
	PB_Symbol->setGeometry(154,16,bk_pixmap_press.width(),bk_pixmap_press.height());
	...
	PB_Digital->setGeometry(85,63,bk_pixmap_press.width(),bk_pixmap_press.height());
	...
	PB_Edit->setGeometry(154,63,bk_pixmap_press.width(),bk_pixmap_press.height());
	...
	PB_Voice->setGeometry(154,63,bk_pixmap_press.width(),bk_pixmap_press.height());
	...
	hideButton->setGeometry(203,114,bk_pixmap_press.width(),bk_pixmap_press.height());
