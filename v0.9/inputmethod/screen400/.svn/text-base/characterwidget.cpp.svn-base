...
const SymbolButMember symbolParameter[keyNumber]=    
{
	...
	{FX+21,						FY+keyheight+Vinterval,	Width,keyheight,(char *)("《")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+Width+Hsbacing,		FY+keyheight+Vinterval,	Width,keyheight,(char *)("》")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*2,	FY+keyheight+Vinterval,	Width,keyheight,(char *)("\\")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*3,	FY+keyheight+Vinterval,	Width,keyheight,(char *)("(")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*4,	FY+keyheight+Vinterval,	Width,keyheight,(char *)(")")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*5,	FY+keyheight+Vinterval,	Width,keyheight,(char *)("…")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*6,	FY+keyheight+Vinterval,	Width,keyheight,(char *)("/")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*7,	FY+keyheight+Vinterval,	Width,keyheight,(char *)("~")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*8,	FY+keyheight+Vinterval,	Width,keyheight,(char *)("@")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},

	{FX+21+(Width+Hsbacing)*1,	FY+(keyheight+Vinterval)*2,Width,keyheight,(char *)("_")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*2,	FY+(keyheight+Vinterval)*2,Width,keyheight,(char *)("√")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*3,	FY+(keyheight+Vinterval)*2,Width,keyheight,(char *)("^")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*4,	FY+(keyheight+Vinterval)*2,Width,keyheight,(char *)("<")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*5,	FY+(keyheight+Vinterval)*2,Width,keyheight,(char *)(">")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*6,	FY+(keyheight+Vinterval)*2,Width,keyheight,(char *)("【")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*7,	FY+(keyheight+Vinterval)*2,Width,keyheight,(char *)("】")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	...
	{FX+21+(Width+Hsbacing)*1,	FY+(keyheight+Vinterval)*2,Width,keyheight,(char *)("々")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*2,	FY+(keyheight+Vinterval)*2,Width,keyheight,(char *)("∮")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*3,	FY+(keyheight+Vinterval)*2,Width,keyheight,(char *)("±")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*4,	FY+(keyheight+Vinterval)*2,Width,keyheight,(char *)("№")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{FX+21+(Width+Hsbacing)*5,	FY+(keyheight+Vinterval)*2,Width,keyheight,(char *)("∠")/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	...
	{415,	95,		60,42,(char *)("change")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{5,		95,		62,42,(char *)("del")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{362,	95,		52,42,(char *)("space")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{425,	5,		50,42,(char *)("hide")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
	{404,	50,		50,42,(char *)("next")	/*,QPixmap(""),QPixmap(""),QPixmap("")*/},
};
	...
	for(i=0;i<keyNumber;i++)
	{
			...
			&& (event->y() > symbolParameter[i].y) && (event->y() < symbolParameter[i].y + symbolParameter[i].Vheigth))
		{
			if(lastKeyId != i)
			{
				...
				if(i<26)
				{
					showPressLarge(tmp,this->geometry().x()+symbolParameter[i].x,this->geometry().y()+symbolParameter[i].y - 70,56,68);
				}
