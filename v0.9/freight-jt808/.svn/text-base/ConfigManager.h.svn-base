...
public:
    ...
    static int IsVDRLocked();
    static void vdrLocked();
    static void vdrUnLocked();
    ...
    static int m_control; //0 master 1 secondary 2 ic card 3 fast register
