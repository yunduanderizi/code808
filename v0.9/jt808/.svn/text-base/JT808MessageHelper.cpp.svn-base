...
Vint unReceivedNum;
int emergency_notify;
int emergency_last=0;
...
SQLiteSequence value_sleep_tmp(8);
...
extern DBusServerC    *g_pDbusServer;
extern string main_server;
extern string second_server;
extern int port;
...
static map<int, StruJT808Para> JT808ParastoMcu;
static map<int, StruJT808Para> JT808BaseconfigtoMcu;
...
void JT808MessageHelper::Init(JT808MessageHandler *handler)
{
   ...
   // JT808Paras.insert(map<int, StruJT808Para>::value_type(0x0064, StruJT808Para((int)VDR_PARA_TIME_CAPTURE_SET,          ENUM_SQLite_COLUMN_INTEGER,     4)));
    ...
    JT808ParastoMcu.clear();
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0001, StruJT808Para((int)VDR_PARA_HEART_BEAT_INTERVAL,       ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0002, StruJT808Para((int)VDR_PARA_TCP_REPLY_TIMEOUT,         ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0003, StruJT808Para((int)VDR_PARA_TCP_RETRY_TIMES,           ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0004, StruJT808Para((int)VDR_PARA_UDP_REPLY_TIMEOUT,         ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0005, StruJT808Para((int)VDR_PARA_UDP_RETRY_TIMES,           ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0006, StruJT808Para((int)VDR_PARA_SMS_REPLY_TIMEOUT,         ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0007, StruJT808Para((int)VDR_PARA_SMS_RETRY_TIMES,           ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0010, StruJT808Para((int)VDR_PARA_MAIN_SERVER_APN,           ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0011, StruJT808Para((int)VDR_PARA_MAIN_SERVER_USERNAME,      ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0012, StruJT808Para((int)VDR_PARA_MAIN_SERVER_PASSWORD,      ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0013, StruJT808Para((int)VDR_PARA_MAIN_SERVER_ADDRESS,       ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0014, StruJT808Para((int)VDR_PARA_SECOND_SERVER_APN,         ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0015, StruJT808Para((int)VDR_PARA_SECOND_SERVER_USERNAME,    ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0016, StruJT808Para((int)VDR_PARA_SECOND_SERVER_PASSWORD,    ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0017, StruJT808Para((int)VDR_PARA_SECOND_SERVER_ADDRESS,     ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0018, StruJT808Para((int)VDR_PARA_TCP_PORT,                  ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0019, StruJT808Para((int)VDR_PARA_UDP_PORT,                  ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x001A, StruJT808Para((int)VDR_PARA_IC_MAIN_SERVER_IP_ADDR,    ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x001B, StruJT808Para((int)VDR_PARA_IC_MAIN_SERVER_TCP_PORT,   ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x001C, StruJT808Para((int)VDR_PARA_IC_MAIN_SERVER_UDP_PORT,   ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x001D, StruJT808Para((int)VDR_PARA_IC_SECOND_SERVER_IP_ADDR,     ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0020, StruJT808Para((int)VDR_PARA_LOC_REPORT_POLICY,         ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0021, StruJT808Para((int)VDR_PARA_LOC_REPORT_SCENARIO,       ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0022, StruJT808Para((int)VDR_PARA_NOLOGIN_REPORT_INTERVAL,   ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0027, StruJT808Para((int)VDR_PARA_SLEEP_REPORT_INTERVAL,     ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0028, StruJT808Para((int)VDR_PARA_EMERGENCY_REPORT_INTERVAL, ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0029, StruJT808Para((int)VDR_PARA_DEFAULT_REPORT_INTERVAL,   ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x002C, StruJT808Para((int)VDR_PARA_DEFAULT_REPORT_DISTANCE,   ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x002D, StruJT808Para((int)VDR_PARA_NOLOGIN_REPORT_DISTANCE,   ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x002E, StruJT808Para((int)VDR_PARA_SLEEP_REPORT_DISTANCE,     ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x002F, StruJT808Para((int)VDR_PARA_EMERGENCY_REPORT_DISTANCE, ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0030, StruJT808Para((int)VDR_PARA_TURN_ANGLE,                ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0031, StruJT808Para((int)VDR_PARA_FENCE_RADIUS,              ENUM_SQLite_COLUMN_INTEGER,     2)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0040, StruJT808Para((int)VDR_PARA_PLATFORM_TEL,              ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0041, StruJT808Para((int)VDR_PARA_RESET_TEL,                 ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0042, StruJT808Para((int)VDR_PARA_FACTORY_RESET_TEL,         ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0043, StruJT808Para((int)VDR_PARA_PLATFORM_SMS,              ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0044, StruJT808Para((int)VDR_PARA_REPORT_SMS,                ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0045, StruJT808Para((int)VDR_PARA_CALL_ANSWER_POLICY,        ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0046, StruJT808Para((int)VDR_PARA_CALL_DURATION_ONCE,        ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0047, StruJT808Para((int)VDR_PARA_CALL_DURATION_MONTH,       ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0048, StruJT808Para((int)VDR_PARA_MONITOR_TEL,               ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0049, StruJT808Para((int)VDR_PARA_MONITOR_SMS,               ENUM_SQLite_COLUMN_STRING,      0)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0050, StruJT808Para((int)VDR_PARA_WARNING_MASK,              ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0051, StruJT808Para((int)VDR_PARA_WARNING_SMS_MASK,          ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0052, StruJT808Para((int)VDR_PARA_WARNING_PHOTO_MASK,        ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0053, StruJT808Para((int)VDR_PARA_WARNING_PHOTOSAVE_MASK,    ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0054, StruJT808Para((int)VDR_PARA_WARNING_KEY_MASK,          ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0055, StruJT808Para((int)VDR_PARA_MAX_SPEED,                 ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0056, StruJT808Para((int)VDR_PARA_OVERSPEED_DURATION,        ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0057, StruJT808Para((int)VDR_PARA_CONT_DRIVE_THRESHOLD,      ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0058, StruJT808Para((int)VDR_PARA_DAY_DRIVE_THRESHOLD,       ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0059, StruJT808Para((int)VDR_PARA_REST_MIN,                  ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x005A, StruJT808Para((int)VDR_PARA_PARKING_MAX,               ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x005B, StruJT808Para((int)VDR_PARA_OVERSPEED_WARNING,         ENUM_SQLite_COLUMN_INTEGER,     2)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x005C, StruJT808Para((int)VDR_PARA_TIRED_DRIVE_WARNING,       ENUM_SQLite_COLUMN_INTEGER,     2)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x005D, StruJT808Para((int)VDR_PARA_COLLISION_ALARM,           ENUM_SQLite_COLUMN_INTEGER,     2)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x005E, StruJT808Para((int)VDR_PARA_ROLLOVER_ALARM,            ENUM_SQLite_COLUMN_INTEGER,     2)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0064, StruJT808Para((int)VDR_PARA_TIME_CAPTURE_SET,          ENUM_SQLite_COLUMN_INTEGER,     4)));
   JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0065, StruJT808Para((int)VDR_PARA_DISTANCE_CAPTURE_SET,      ENUM_SQLite_COLUMN_INTEGER,     4)));
   JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0070, StruJT808Para((int)VDR_PARA_PHOTO_QUALITY,             ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0071, StruJT808Para((int)VDR_PARA_PHOTO_BRIGHTNESS,          ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0072, StruJT808Para((int)VDR_PARA_PHOTO_CONTRAST,            ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0073, StruJT808Para((int)VDR_PARA_PHOTO_SATUATION,           ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0074, StruJT808Para((int)VDR_PARA_PHOTO_CHROMA,              ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0090, StruJT808Para((int)VDR_PARA_GNSS_LOC_MODE,             ENUM_SQLite_COLUMN_INTEGER,     1)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0091, StruJT808Para((int)VDR_PARA_GNSS_BAUD_RATE,            ENUM_SQLite_COLUMN_INTEGER,     1)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0092, StruJT808Para((int)VDR_PARA_GNSS_DATA_OUT_RATE,        ENUM_SQLite_COLUMN_INTEGER,     1)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0093, StruJT808Para((int)VDR_PARA_GNSS_DATA_COLLECT_RATE,    ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0094, StruJT808Para((int)VDR_PARA_GNSS_DATA_UPLOAD_MODE,     ENUM_SQLite_COLUMN_INTEGER,     1)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0095, StruJT808Para((int)VDR_PARA_GNSS_DATA_UPLOAD_SET,      ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0100, StruJT808Para((int)VDR_PARA_CAN_1_COLLECT_INTERVAL,    ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0101, StruJT808Para((int)VDR_PARA_CAN_1_UPLOAD_INTERVAL,     ENUM_SQLite_COLUMN_INTEGER,     2)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0102, StruJT808Para((int)VDR_PARA_CAN_2_COLLECT_INTERVAL,    ENUM_SQLite_COLUMN_INTEGER,     4)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0103, StruJT808Para((int)VDR_PARA_CAN_2_UPLOAD_INTERVAL,     ENUM_SQLite_COLUMN_INTEGER,     2)));
    JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0110, StruJT808Para((int)VDR_PARA_CAN_ID_COLLECT_SET,        ENUM_SQLite_COLUMN_SEQUENCE,     8)));
    //JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0111, StruJT808Para((int)VDR_PARA_OTHER_CAN_ID_COLLECT_SET,  ENUM_SQLite_COLUMN_SEQUENCE,     8)));
    //JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0194, StruJT808Para((int)VDR_DEPLOY_PARA_ID,       	 	 ENUM_SQLite_COLUMN_SEQUENCE,     7)));
    //JT808ParastoMcu.insert(map<int, StruJT808Para>::value_type(0x0195, StruJT808Para((int)VDR_DEPLOY_PARA_PHONE_NUMBER,       ENUM_SQLite_COLUMN_STRING,     0)));

	JT808BaseconfigtoMcu.clear();
	JT808BaseconfigtoMcu.insert(map<int, StruJT808Para>::value_type(0x002A,StruJT808Para((int) VDR_BASE_STATUS_D2,             ENUM_SQLite_COLUMN_SEQUENCE, 8 )));
}
...
void JT808MessageHelper::push_loc_mileage(JT808Packet & packet)
{
	int index=0;
	int mileage=0;
	int value=0;
	VDRLocStatus2Table *table = new VDRLocStatus2Table();
	index =table->RefreshBottom();
    if(index < 0)
    {
        LogUtility::Log(LOG_LEVEL_ERROR, "JT808MessageHelper::SendBusDDriverData RefreshNearest start time failed().");
        delete table;
        return ;
    }
	table->GetIntValue(VDR_LOCS_TOTAL_MILEAGE, mileage);
	m_handler->PushLong(packet, (unsigned long)0x80);
	m_handler->PushByte(packet, 0x04);
	printf("milage1=============================================================%d \n",mileage);
	value=mileage;
	//m_handler->PushLong(packet, (unsigned long)value);
	packet.push_back((unsigned char)((mileage >> 24) & 0xFF));
	packet.push_back((unsigned char)((mileage >> 16) & 0xFF));
	packet.push_back((unsigned char)((mileage >> 8) & 0xFF));
	packet.push_back((unsigned char)(mileage & 0xFF));


	printf("111111111111  %02x \n",(unsigned char)((mileage >> 24) & 0xFF));
	printf("222222222222  %02x \n",(unsigned char)((mileage >> 16) & 0xFF));
	printf("333333333333  %02x \n",(unsigned char)((mileage >> 8) & 0xFF));
	printf("444444444444  %02x \n",(unsigned char)(mileage & 0xFF));
	printf("milage=============================================================%d \n",mileage);
	return;		
}
void JT808MessageHelper::push_deploy_para(JT808Packet & packet)
{
    ...
    for(map<int, StruJT808Para>::iterator it = JT808ReadOnlyParas.begin(); it != JT808ReadOnlyParas.end(); it ++)
    {
        ...
        {
            string value = "";
			deploytable->GetStringValue(para.colid, value);
...
void JT808MessageHelper::SendLocationbypass(struct LocStatusData &locData,int lock_door)
{
	...
	emergency = locData.alarm_signal&0x00000001;
	printf("SendLocationbypass::emergency_notify   %d emergency_last %d flag_emergency %d emergency %d \n",emergency_notify,emergency_last,flag_emergency,emergency);
	if(emergency_notify==2)
	{
		if (emergency==0&&emergency_last==1)
		{		
			emergency_notify=0;
			flag_emergency=0;
		}
		else if (emergency==1&&emergency_last==0)
		{
			emergency_notify=0;
			flag_emergency=0;
		}
	}
	else if (emergency_notify==0)
	{
		if (emergency==1)
		{	
			emergency_notify=1;
	...
	if (tmp==0)
	{
		...
		shutdown_flag=1;
		printf("*************************************alarm    0  shutdown_flag  %d \n",shutdown_flag);
	...
	printf("11111111111111111  loctimelast  %d*************888locData.itime===%d \n",loctimelast,locData.itime);
    m_handler->PushSequence(packet, bcdTime, 6);
...
void JT808MessageHelper::SendDregControl(unsigned short seq,int flag)
{
	 seq_bak = seq;
        JT808DregCommonNotifyC notify;
	notify.type =flag;//发送激活dbus 给devicemanager
...
void JT808MessageHelper::HandleSetParameters(JT808Packet &packet, int body, int len, unsigned short seq)
{
    ...
    baseconfigtable->GetSequenceValue(VDR_BASE_STATUS_D2, value_sleep);
	printf("value_sleep  **************\n");
	if (value_sleep.empty())
	{
		LogUtility::Log(LOG_LEVEL_ERROR, "JT808MessageHandler::JT808MessageHandler get value_sleep failed");
	}
	else 
	{
		for(int m=0;m<8;m++)
		{
			printf(" %02x ",value_sleep[m]);
		}
	}
	printf ("len ===============================%d \n",len);
    for(int i = 0; i < count; i ++)
    {
        ...
        if(id ==0x13||id ==0x17|| id == 0x18 || id == 0x19)
            rec = 2;
        ...
        else if(para.type == ENUM_SQLite_COLUMN_SEQUENCE)
        {
		 ...
		 if(id == 0x002A)
		 {
			if (value_sleep.empty())
			{
				for(int j = 0; j < paralen; j ++)
	           	{
	                	value_sleep_tmp[j] = JT808_GET_BYTE(packet, body);
	                	body ++;
	            }	
			    accu_len += paralen;
	            baseconfigtable->SetSequenceValue((int)para.colid, value_sleep_tmp);
			}
			else{
				for(int j = 0; j < paralen; j ++)
	           	{
	...
	sleep(4);
	printf("11111111111111111111111111111111111111111111112222222222222222222222222222222222222222222222222222222222\n");
...
void JT808MessageHelper::HandleAlarmConfirm(JT808Packet &packet, int body, int len, unsigned short seq)
{
	...
	printf("HandleAlarmConfirm::emergency_notify   %d emergency_last %d flag_emergency %d  \n",emergency_notify,emergency_last,flag_emergency);
    int seq1= JT808_GET_SHORT(packet, body);
    body += 2;
    int confirm= JT808_GET_LONG(packet, body);
    if (confirm==1)
	{	
		emergency_notify=2;//取消紧急报警
...
void JT808MessageHelper::HandleQuestion(JT808Packet &packet, int body, int len, unsigned short seq)
{
    ...
    if(table->SetIntValue((int)VDR_QUESTIONS_FLAG,flag8081)<0)
    {
...
void JT808MessageHelper::HandleCarControl(JT808Packet &packet, int body, int len, unsigned short seq)
{
    ...
    SendDregControl(seq,flag);
	VDRDregInfoTable *table = new VDRDregInfoTable();
	if (table->SetIntValue(VDR_DREG_ACTIVE_DISABLE,flag)<0)
	{
		LogUtility::Log(LOG_LEVEL_ERROR, "JT808MessageHelper::SetVDRDregInfoTable flag wrong  is %d\n", flag);
		return;
	}
...
void JT808MessageHelper::Stringslice(string &utf_value,string &str, vector<string> *result)
{
	int pos;
	utf_value +=str;
	int size=utf_value.size();
	for (int i=0;i<size;i++)
	{
		printf("111111111111111111  utf_value.size() %d \n",utf_value.size());
		pos=utf_value.find(str,i);
		if (pos<size)
		{
			string str_tmp=utf_value.substr(i,pos-i);
			printf("*************8 str_tmp\n",str_tmp.c_str());
...
void JT808MessageHelper::HandlePacketDownTransparentTransmission(JT808Packet &packet, int body, int len, unsigned short seq)
{
	...
	switch(type)
	{
		...
		case JT808_TT_ACTIVATION:  
			{
				...
				status= JT808_GET_BYTE(packet, body);
				body++;
				num=len-2;
				...
				for(int j = 0; j < num; j ++)
	            		...
	            		string utf_value = boost::locale::conv::to_utf<char>(value, JT808_CHAR_SET);
				printf("utf_value                  %s \n",utf_value.c_str());
				Stringslice(utf_value,str,&result);
				VDRDregICTable * dregtable = new VDRDregICTable();
				int write_time = time(NULL);
				if (status ==0)
				{
					printf("status=======================%d \n",status);
					int ret=dregtable->RefreshTop();
					printf("ret =====%d \n",ret);
					for(int i=0 ; i<result.size(); i++)
					{
					    if(dregtable->SetIntValue((int)VDR_DREG_IC_OCCUR_TIME,write_time)<0)
					    {
					    	LogUtility::Log(LOG_LEVEL_ERROR, "JT808MessageHelper::Handlerdregtable write table time faild");
							delete dregtable;
							SendAck(seq, (unsigned short)JT808_PACKET_DOWN_TRANSPARENT_TRANSMISSION, (int)ENUM_JT808_COMMON_ERROR);
							return;
					    }
						 if(dregtable->SetStringValue((int)VDR_DREG_IC_LICENSE_NUM,result[i])<0)
					    {
					    	LogUtility::Log(LOG_LEVEL_ERROR, "JT808MessageHelper::Handlerdregtable license faild");
							delete dregtable;
							SendAck(seq, (unsigned short)JT808_PACKET_DOWN_TRANSPARENT_TRANSMISSION, (int)ENUM_JT808_COMMON_ERROR);
							return;
					    }
				...
				else if (status==1)
				{
						if (len==2)
						{
							int ret=dregtable->RefreshTop();
							printf("ret =======================%d \n",ret);
							if (dregtable->DeleteAll()<0)
							{
								LogUtility::Log(LOG_LEVEL_ERROR, "JT808MessageHelper::Handlerdregtable delete number all faild");
								delete dregtable;
								SendAck(seq, (unsigned short)JT808_PACKET_DOWN_TRANSPARENT_TRANSMISSION, (int)ENUM_JT808_COMMON_ERROR);
								return;
							}
						...
						{
							int ret=dregtable->RefreshTop();
							printf("ret =======================11111111111111111111%d \n",ret);
							for(int i=0;i<result.size();i++)
							{
								if (dregtable->Delete(result[i])<0)
								{
									LogUtility::Log(LOG_LEVEL_ERROR, "JT808MessageHelper::Handlerdregtable delete table IC number faild");
									delete dregtable;
									SendAck(seq, (unsigned short)JT808_PACKET_DOWN_TRANSPARENT_TRANSMISSION, (int)ENUM_JT808_COMMON_ERROR);
									return;
								}
		...
		case JT808_TT_USERB:
				notify.type = type;
				SpeedSwitch=JT808_GET_BYTE(packet, body);
				body++;
				SpeedLimit= (int)JT808_GET_BYTE(packet, body);
				body++;
				notify.buf[0]= JT808_GET_BYTE(packet, body);
				body++;
				notify.buf[1]= JT808_GET_BYTE(packet, body);
				body++;
				notify.buf[2]= JT808_GET_BYTE(packet, body);
				body++;
				notify.buf[3]= JT808_GET_BYTE(packet, body);
				notify.errnum= SpeedSwitch;
				notify.total =SpeedLimit;
				LimitTime=(notify.buf[0]<<24)|(notify.buf[1]<<16)|(notify.buf[2]<<8)|notify.buf[3];
				printf("HandlePacketDownTransparentTransmission::TYPE %d errnum  %d  total  %d buf[0] %02x buf[1] %02x buf [2] %02x buf[3] %02x  LimitTime %d \n",notify.type,notify.errnum,notify.total,notify.buf[0],notify.buf[1],notify.buf[2],notify.buf[3],LimitTime);
				g_pDbusServer->sendNotify(&notify);
				SendAck(seq, (unsigned short)JT808_PACKET_DOWN_TRANSPARENT_TRANSMISSION, (int)ENUM_JT808_COMMON_OK);
				break;
		case JT808_TT_IC: 
...
void  JT808MessageHelper::HandleSystemRestFactory()
{
    ...
    if(table->SetStringValue((int)VDR_PARA_MAIN_SERVER_ADDRESS, main_server) < 0)
    {
	    LogUtility::Log(LOG_LEVEL_ERROR, "JT808MessageHelper::HandleRegisterResult get auth token failed");
	    delete table;
	    return;
    }
	 if(table->SetStringValue((int)VDR_PARA_SECOND_SERVER_ADDRESS, second_server) < 0)
    {
	    LogUtility::Log(LOG_LEVEL_ERROR, "JT808MessageHelper::HandleRegisterResult set second_server token failed");
	    delete table;
	    return;
    }
	  if(table->SetIntValue((int)VDR_PARA_TCP_PORT, port) < 0)
    {
	    LogUtility::Log(LOG_LEVEL_ERROR, "JT808MessageHelper::HandleRegisterResult set port token failed");
	    delete table;
	    return;
    }
	printf("write the  table is all right  *********************************************************88\n");
	table->Commit();
	delete table;
	 sleep(2);
      ConfigManager::Refresh();
...
void JT808MessageHelper::push_loc_mileage_to_mcu(JT808Packet & packet)
{
	int index=0;
	int mileage=0;
	VDRLocStatus2Table *table = new VDRLocStatus2Table();
...
void JT808MessageHelper::push_deploy_para_to_mcu(JT808Packet & packet)
{
    VDRDeployParaTable *deploytable = new VDRDeployParaTable();
	int i;
    for(map<int, StruJT808Para>::iterator it = JT808ReadOnlyParas.begin(); it != JT808ReadOnlyParas.end(); it ++)
    {
		...
		{
			i=1;
			push_loc_mileage_to_mcu(packet);
		}
        StruJT808Para &para = it->second;
        ...
        else if(para.type == ENUM_SQLite_COLUMN_STRING)
        {
            ...
            //m_handler->PushByte(packet, (unsigned char)(gb_value.length()));
            //printf("id =============================================%02x   gb_value  %s \n",id,gb_value.c_str());
            m_handler->PushStringToMcu(packet, gb_value,id);
        }
        else
        {
            LogUtility::Log(LOG_LEVEL_ERROR, "JT808MessageHelper::SendParameters para type not match 2");
...
void JT808MessageHelper::push_baseconfig_para_to_mcu(JT808Packet & packet)
{
	SQLiteSequence value_get_to_mcu(8);
    VDRBaseConfigTable *baseconfig = new VDRBaseConfigTable();
	for(map<int, StruJT808Para>::iterator it = JT808BaseconfigtoMcu.begin(); it != JT808BaseconfigtoMcu.end(); it ++)
	{
        int id = it->first;
		//printf("id =============================================%02x \n",id);
        StruJT808Para &para = it->second;
        ...
        {
            int value = 0;
            baseconfig->GetIntValue(para.colid, value);
            if(para.len == 1)
            {
                //m_handler->PushByte(packet, 0x01);
                m_handler->PushByte(packet, (unsigned char)value);
        ...
        else if(para.type == ENUM_SQLite_COLUMN_STRING)
        {
            ...
            string gb_value = boost::locale::conv::from_utf<char>(value, JT808_CHAR_SET);
            baseconfig->GetStringValue(para.colid, gb_value);
            //m_handler->PushByte(packet, (unsigned char)(gb_value.length()));
            //printf("id =============================================%02x   gb_value  %s \n",id,gb_value.c_str());
            m_handler->PushStringToMcu(packet, gb_value,id);
        }
        ...
        {
            vector<unsigned char> value;
            baseconfig->GetSequenceValue(para.colid, value);
            m_handler->PushSequence(packet, value, para.len);
        }
        else
        {
...
int  JT808MessageHelper::GetParametersTOMcu(unsigned char * buf_para)
{
    int paracount, i=0,m=0;
    StruJT808Packet *thepacket = m_handler->CreatePacket();
	
    thepacket->reply = true;
    paracount = JT808ParastoMcu.size();
    paracount += JT808ReadOnlyParas.size();
	paracount += JT808BaseconfigtoMcu.size();
    JT808Packet &packet = thepacket->packet;
    VDRRunParaTable *table = new VDRRunParaTable();
    for(map<int, StruJT808Para>::iterator it = JT808ParastoMcu.begin(); it != JT808ParastoMcu.end(); it ++)
    {
        int id = it->first;
        if(id > 0x74 && i == 0)
        {
            i=1;
            push_deploy_para_to_mcu(packet);
        }
		if (id>0x29&&m ==0 )
		{
			m=1;
			push_baseconfig_para_to_mcu(packet);
		}
        if(id > 0x110) break;
        StruJT808Para &para = it->second;
       // m_handler->PushLong(packet, (unsigned long)id);
        ...
        else if(para.type == ENUM_SQLite_COLUMN_STRING)
        {
            ...
            table->GetStringValue(para.colid, value);
			//printf("id =============================================%02x   gb_value  %s \n",id,value.c_str());
            m_handler->PushStringToMcu(packet, value,id);
        }
        else if(para.type == ENUM_SQLite_COLUMN_SEQUENCE)
        {
            vector<unsigned char> value;
	 ...
	 delete table;
		...
		JT808Packet &content=thepacket->packet;
		unsigned char  m_send_buffer[1024];
			...
			memcpy(buf_para,m_send_buffer,m_send_len);
		#if 1		
			for(int i = 0; i < m_send_len; i ++)
			{
				printf("%02x ", m_send_buffer[i]);
				if((i + 1) %15 == 0)
				{
					printf("\r\n");
				}
