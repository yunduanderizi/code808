...
#define JT808_DBUS_REQ_ID_SHUTDOWN		            6803
#define JT808_DBUS_REQ_ID_COMMON_EVENT              6804
#define JT808_DBUS_NTF_ID_ParModify					6805
#define JT808_DBUS_NTF_ID_NETBREAK 					6806
#define JT808_DBUS_NTF_ID_EMERGENCY					6807
#define JT808_DBUS_NTF_ID_JT808SleepWakeServer2NotifyC    1111

#define JT808_DBUS_NTF_ID_DREG_COMMON			    6900
#define JT808_DBUS_REQ_ID_DREG_COMMON               6901
...
class JT808CommonEventReqC : public DBusRequestC
{
    DBUS_REQUEST_OBJECT(JT808CommonEventReqC)

public:
    JT808CommonEventReqC():DBusRequestC(JT808_DBUS_REQ_ID_COMMON_EVENT){}
    
    int type;   // 1:恢复出厂设置2 sim 修改 3  第二服务器修改4、进入南斗界面
    int value;
};

class JT808SleepWakeServer2NotifyC : public DBusNotifyC
{
    DBUS_NOTIFY_OBJECT(JT808SleepWakeServer2NotifyC)

public:
    JT808SleepWakeServer2NotifyC():DBusNotifyC(JT808_DBUS_NTF_ID_JT808SleepWakeServer2NotifyC){}
    
  
	int seq;
};

class JT808ParModifyNotifyC : public DBusNotifyC
{
	DBUS_NOTIFY_OBJECT(JT808ParModifyNotifyC)
public:
	JT808ParModifyNotifyC():DBusNotifyC(JT808_DBUS_NTF_ID_ParModify){}

	int type; // 1 修改注册参数2 修改手机号3 联网通知
	
};


class JT808NetBreakNotifyC : public DBusNotifyC
{
	DBUS_NOTIFY_OBJECT(JT808NetBreakNotifyC)
public:
	JT808NetBreakNotifyC():DBusNotifyC(JT808_DBUS_NTF_ID_NETBREAK){}
	
};
class JT808EmergencyNotifyC : public DBusNotifyC
{
	DBUS_NOTIFY_OBJECT(JT808EmergencyNotifyC)
public:
	JT808EmergencyNotifyC():DBusNotifyC(JT808_DBUS_NTF_ID_EMERGENCY){}
	
};


//渣土车dbus
class JT808DregCommonNotifyC : public DBusNotifyC
{
    DBUS_NOTIFY_OBJECT(JT808DregCommonNotifyC)

public:
    JT808DregCommonNotifyC():DBusNotifyC(JT808_DBUS_NTF_ID_DREG_COMMON){}
    
    int type;   // 1 激活;  0 解锁; 
    int value;
};

class JT808DregCommonReqC : public DBusRequestC
{
    DBUS_REQUEST_OBJECT(JT808DregCommonReqC)

public:
    JT808DregCommonReqC():DBusRequestC(JT808_DBUS_REQ_ID_DREG_COMMON){}
